...
class TestGamePieceMovement(unittest.TestCase):
    ...
    def test_a_piece_moves(self):
        ...
        self.assertEqual((x+40,y+70), (self.gamestate.one_piece.rect.left, self.gamestate.one_piece.rect.top))
    ...
    def test_multiple_pieces_move(self):
        ...
        for piece in self.gamestate.pieces:
            ...
            self.assertEqual((x+120,y+-200), (piece.rect.left, piece.rect.top))
